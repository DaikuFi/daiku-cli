...
Maintainers create drafts from GitHub Actions' **Draft release** workflow using
either a stable version such as `v1.2.0` or a prerelease such as `v0.2.0-rc.1`.
Only stable releases reach the Homebrew tap. The workflow only runs from `main`, uses
